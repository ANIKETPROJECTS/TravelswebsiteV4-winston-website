...
- WhatsApp number: +91 89280 00407
...
- **Marketing Campaign Urgency Features** (December 2025):
  - Added CountdownTimer component with localStorage persistence (15-minute countdown)
  - Added PricingSection component with "Limited Time Marketing Offer" heading
  - Three pricing tiers: Starter (₹999, 30% OFF), Pro (₹1,999, 50% OFF), Elite (₹3,999, 40% OFF)
  - Each tier shows discount badges, crossed-out original prices, urgency text, and feature lists
  - "Most Popular" badge on Pro tier
  - Added BottomStickyCta sticky bar at bottom of page:
    - Shows discounted price (₹49) with crossed-out original (₹999)
    - Live countdown timer in MM:SS format
    - Orange "Book My Spot" CTA button
  - Adjusted WhatsApp floating button and scroll-to-top button positions above sticky bar
  - All buttons open WhatsApp with pre-filled messages
  - Timer persists across page reloads using localStorage
- **Hero Section Redesign** (December 2025):
  - Two-column layout: content left, transformation visuals right
  - Left column: Headline, subtext, CTA buttons, founder's motivational quote
  - Right column: Auto-scrolling transformation images carousel (25s animation, 8 images duplicated for seamless loop)
  - Featured testimonial card below carousel with avatar, name, role, review, and 5-star rating
  - Green borders on transformation images
  - Pause animation on hover (works on parent container)
  - Right column hidden on mobile (lg:block) for clean mobile experience
