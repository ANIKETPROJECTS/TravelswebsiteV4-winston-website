              ...
              {[
                ...
                >
                  <div className="flex items-start gap-3 p-3 md:p-4 bg-white/70 backdrop-blur-sm rounded-xl border border-primary/10 hover:border-primary/30 hover:bg-white/90 transition-all duration-300 hover:shadow-md">
                    <div className="w-10 h-10 md:w-11 md:h-11 rounded-lg bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:scale-105 transition-transform duration-300">
          ...
          <div className="container px-4 md:px-6 max-w-7xl mx-auto relative">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-card shadow-xl border-2 border-primary/20 p-5 md:p-6">
                  <CardContent className="p-0">
                    <div className="flex items-center gap-3 mb-5">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center shadow-lg">
                ...
                {/* Business Hours Card */}
                <Card className="bg-gradient-to-br from-brand-500 to-brand-600 shadow-xl p-5 md:p-6">
                  <CardContent className="p-0">
                ...
                <CardContent className="p-0 flex flex-col flex-1">
                  ...
                  <div className="space-y-3 flex flex-col flex-1">
                    ...
                    <div className="flex items-start gap-3 bg-brand-50 rounded-lg p-3 border border-primary/10">
                      <div className="w-8 h-8 rounded-md bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center flex-shrink-0">
                    ...
                    {/* Address */}
                    <div className="flex items-start gap-3 bg-brand-50 rounded-lg p-3 border border-primary/10">
                      <div className="w-8 h-8 rounded-md bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center flex-shrink-0 mt-0.5">
